...
class ConfigApi
{
     ...
     * @return \Swagger\Client\Model\GetConfigResponse[]
     */
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\GetConfigResponse[], HTTP status code, HTTP response headers (array of strings)
     */
    public function configGetWithHttpInfo()
    {
        $returnType = '\Swagger\Client\Model\GetConfigResponse[]';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\GetConfigResponse[]',
