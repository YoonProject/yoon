...
class CalendarApi
{
     ...
     * @return \Swagger\Client\Model\GetCalendarBlockDataResponse
     */
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\GetCalendarBlockDataResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function calendarHeightDataGetWithHttpInfo($height)
    {
        $returnType = '\Swagger\Client\Model\GetCalendarBlockDataResponse';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\GetCalendarBlockDataResponse',
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\GetCalendarBlockResponse
     */
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\GetCalendarBlockResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function calendarHeightGetWithHttpInfo($height)
    {
        $returnType = '\Swagger\Client\Model\GetCalendarBlockResponse';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\GetCalendarBlockResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\GetCalendarBlockHashResponse
     */
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\GetCalendarBlockHashResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function calendarHeightHashGetWithHttpInfo($height)
    {
        $returnType = '\Swagger\Client\Model\GetCalendarBlockHashResponse';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\GetCalendarBlockHashResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
