...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'http://35.230.179.171';

    /**
     * User agent of the HTTP request, set to "PHP-Chainpoint" by default
     *
     * @var string
     */
    protected $userAgent = 'Chainpoint-Codegen/1.0.0/php';
    ...
    {
        $report  = 'PHP SDK (Chainpoint\Client) Debug Report:' . PHP_EOL;
